  ...
  return (
    <nav className="flex flex-wrap items-center justify-between bg-gray-600 px-6 py-3">
      ...
      <div className="block w-full flex-grow lg:flex lg:w-auto lg:items-center">
        ...
        <div>
          <button onClick={() => navigate('/login')} className="mt-4 inline-block rounded border border-gray-400 px-4 py-2 text-sm leading-none text-gray-300 hover:bg-gray-300 hover:text-gray-800 lg:mt-0">
            Login
          </button>          
        </div>
      </div>
